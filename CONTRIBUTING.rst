...
django-app-gen could always use more documentation, whether as part of the
official django-app-gen docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.7 and 3.4+, and for PyPy. Check
   https://travis-ci.org/grantmcconnaughey/django-app-gen/pull_requests
